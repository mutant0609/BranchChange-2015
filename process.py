...
if(False):
	...
	with open('./media/documents/capacities.csv', 'r') as capacities:
	...
	with open('./media/documents/input.csv', 'r') as csvfilename:
	...
	with open('./media/documents/capacities.csv', 'r') as csvfilename:		
		for row in csv.reader(csvfilename):			
